...
assert(surface.includes("renderHome") && surface.includes("openToolSheet") && surface.includes("visionHitsToArrows") && surface.includes("bindLiveScanMode") && surface.includes("bindVideoScanMode") && surface.includes("window.ArcherVision"), "Unified home/scan/tool-sheet layer missing");
...
console.log(`的ノート checks OK (v${version})`);
