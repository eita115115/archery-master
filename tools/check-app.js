...
assert(scripts.includes("homeSightStart") && scripts.includes("homeSightStartWrap") && /max\(min\(82vw,360px\),280px\)/.test(uiLayerCss), "Home large reticle (min 280px) missing");
assert(scripts.includes("launchSheetDetailHtml") && scripts.includes("launchKindCard") && scripts.includes("launchMiniGrid") && scripts.includes("プライバシー設定") && scripts.includes("写真から取り込み") && scripts.includes("シート種類") && scripts.includes("カラーセット") && scripts.includes("スコアシート設定"), "Launch sheet settings UI missing");
