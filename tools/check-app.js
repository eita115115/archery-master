...
assert(/maximum-scale\s*=\s*5/.test(html) && !/user-scalable\s*=\s*no/.test(html), "Viewport must allow zoom (max 5x) for accessibility; scoring uses touch-action:manipulation");
